...
public class KeyStoreLoadingErrorsIT {
    ...
    public void testKsWithoutKeystoresConfig() {
        ...
        assertThrows(RuntimeException.class, () -> app.getInstance(Key.getMapOf(String.class, ExtendedKeystore.class)),
    ...
    public void testKsWithoutKeystorePassword() {
        ...
        assertThrows(RuntimeException.class, () -> {
                    app.getInstance(Key.getMapOf(String.class, ExtendedKeystore.class));
                },
    ...
    public void testKsWithIncorrectKeystoreType() {
        ...
        try {
            ...
            assertTrue(e.getCause().getMessage().startsWith("Incorrect type: "));
        }
    }
    ...
    public void testKsWithIncorrectKeystoreProvider() {
        ...
        try {
            ...
            assertTrue(e.getCause().getMessage().startsWith("Provider not found:"));
        }
    }
}
